...
int main(int argc, char **argv)
{
  ...
  gameRow[gameCols.thumbnail] = Gdk::Pixbuf::create_from_resource("/org/colinkinloch/emulatron/img/lttp.jpg")->scale_simple(100, 100, Gdk::INTERP_NEAREST);
  gameRow = *(gameList->append());
  gameRow[gameCols.title] = "Other game";
  gameRow[gameCols.filename] = "/dev/null";
  gameRow[gameCols.thumbnail] = Gdk::Pixbuf::create_from_resource("/org/colinkinloch/emulatron/img/dino_down.png")->scale_simple(100, 100, Gdk::INTERP_NEAREST);
  gameRow = *(gameList->append());
  gameRow[gameCols.title] = "Game number 3";
  gameRow[gameCols.filename] = "/dev/null";
  gameRow[gameCols.thumbnail] = Gdk::Pixbuf::create_from_resource("/org/colinkinloch/emulatron/img/logo.png")->scale_simple(100, 100, Gdk::INTERP_NEAREST);
  gameRow = *(gameList->append());
  gameRow[gameCols.title] = "Silly big game";
  gameRow[gameCols.filename] = "/dev/null";
  gameRow[gameCols.thumbnail] = Gdk::Pixbuf::create_from_resource("/org/colinkinloch/emulatron/img/joy-angle-1024.png")->scale_simple(100, 100, Gdk::INTERP_NEAREST);
